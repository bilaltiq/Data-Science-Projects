...
When displaying anything to the screen, be it table or plot, make it look nice! That
is, use nice variable names, clean up axes, make the display nice, etc. This means you need to load
library(kableExtra) with your other libraries. This is a good habit to get into now that we've seen commands for these tasks.
