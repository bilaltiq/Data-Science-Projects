...
Solution: It has a clear Title ("Scatterplot of Sepal and Petal Lengths") with an adequate subtitle ("For all 3 iris species"). It has axis labels of Petal Length and Sepal Length. Additionally, it has a legend on the side to identify the different lines.
...
g + geom_point(aes(color=net_users),size=3) +
  scale_y_continuous(name= "Gross Domestic Product (GDP)",trans = "log10",labels = scales::comma) +
  scale_x_continuous(name= "% of GDP spent on education") + 
  theme(legend.position = "top") 
