---
title: "Lab 11 - Iteration and Simulation"
format: pdf
editor: visual
editor_options: 
...
<!-- Asking you to do the plot AFTER the simulation helps keep them in separate code chunks. You don't want to keep running the simulation while just trying to plot results.-->
...
<!-- Remember to commit and push your final version of this final lab file!  -->

<!-- If you finish the lab in class, go work on your project or final homework (practice 9) for class. -->
