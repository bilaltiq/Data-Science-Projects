...
```{=html}
<!--
I called my state-level mapping data `state_map` when working above. You should update the code below to match your dataset name from Part 1.e, or else this won't run.
-->
```
```{r}
# Peek at data
...
# don't work to fix them, just strategize about what you would need to do
# some of you got practice with this in your Shiny app!
```
...
```{=html}
<!-- 
If you use any of the code below, when you get to Practice 7, copy and paste only the code you need into a new code chunk for wrangling and then mapping your data
-->
```
```{r}
#| label: sample_code
