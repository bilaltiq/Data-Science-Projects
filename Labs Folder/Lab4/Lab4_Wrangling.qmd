...
The text and our examples covered a lot of different wrangling commands. Now, it's your turn to generate the necessary code to do the wrangling and make some neat visualizations.
...
If you copied over the Lab 4 folder in its entirety, the file structure should remain the same. If you pulled individual files over, you may need to adjust. In particular, be sure you pulled the data folder or its files. These files aren't hosted via a web url.
...
Solution: The years 2013 to 2016 are covered in the coverage dataset. For the spending dataset it's the years 1991 to 2014. There are some N/A values when we glimpse (coverage).
...
Solution: It changes it from N/A to NA
